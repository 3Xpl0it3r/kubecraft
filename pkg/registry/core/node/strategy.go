...
import (
	...
	legacyscheme "github.com/3Xpl0it3r/kubecraft/pkg/api/legacyscheme"
...
func ResourceLocation(getter ResourceGetter, proxyTransport http.RoundTripper, ctx context.Context, id string) (*url.URL, http.RoundTripper, error) {
